...
export const Route = createLazyFileRoute("/design/dialog/")({
	component: DialogPage
});

function DialogPage() {
	return (
		<ExampleWrapper title="Dialog">
			<DialogWithForm />
				...
				<DialogContent className="min-w-md">
					...
					<div className="flex flex-col gap-4">
						...
						<Tabs value={tab} onValueChange={setTab}>
							...
							<div className="min-h-[550px] rounded-lg border p-6 **:data-[slot=select-trigger]:min-w-[125px]">
