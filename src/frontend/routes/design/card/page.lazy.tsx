...
export const Route = createLazyFileRoute("/design/card/")({
	component: CardPage
});

function CardPage() {
	return (
		<ExampleWrapper title="Card">
			<CardDefault />
			<CardSmall />
		...
		<Example title="Meeting Notes">
			<Card className="mx-auto w-full max-w-sm">
				<CardHeader>
					...
					<CardAction>
						<Button variant="outline" size="sm" startIcon={<CaptionsIcon />}>
							Transcribe
						</Button>
					</CardAction>
				</CardHeader>
				...
				<CardFooter>
					<AvatarGroup className="*:data-[slot=avatar]:ring-card">
						...
						<AvatarGroupCount className="ring-card">+8</AvatarGroupCount>
					</AvatarGroup>
				</CardFooter>
			</Card>
		</Example>
...
function CardWithImage() {
	return (
		<Example title="With Image">
			<Card size="default" className="relative mx-auto w-full max-w-sm">
				<Image
				...
				<CardFooter>
					<Button startIcon={<PlusIcon />} className="w-full">
						Button
					</Button>
				</CardFooter>
			</Card>
	...
	return (
		<Example title="With Image (Small)">
			<Card size="sm" className="relative mx-auto w-full max-w-sm">
				...
				<CardFooter>
					<Button size="sm" startIcon={<PlusIcon />} className="w-full">
						Button
					</Button>
				</CardFooter>
			</Card>
