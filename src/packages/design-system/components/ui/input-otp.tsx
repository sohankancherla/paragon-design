...
// TODO: Find a replacement for OTP primitive
function InputOTP({
	className,
	containerClassName,
	...props
...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useFocusableInteractive: default shadcn code
		<div
			data-slot="input-otp-separator"
			className="flex items-center [&_svg:not([class*='size-'])]:size-4"
			// biome-ignore lint/a11y/useAriaPropsForRole: default shadcn code
			role="separator"
			{...props}
		>
			<MinusIcon />
